...
public class BluetoothLeService extends Service {
    ...
    public void WriteValue(String strValue)
    {
    	...
    	mNotifyCharacteristic.setValue(hexStringToBytes(strValue));
    	mNotifyCharacteristic.setWriteType(BluetoothGattCharacteristic.WRITE_TYPE_NO_RESPONSE);
    	mBluetoothGatt.writeCharacteristic(mNotifyCharacteristic);

		String stateStr = String.valueOf(mBluetoothGatt.writeCharacteristic(mNotifyCharacteristic));
    ...
    private final BluetoothGattCallback mGattCallback = new BluetoothGattCallback() {
        ...
        public void onCharacteristicChanged(BluetoothGatt gatt,
            ...
            broadcastUpdate(ACTION_DATA_AVAILABLE, characteristic);
            byte[] data = characteristic.getValue();
            //Log.e("onCharacteristicChanged", "onCharacteristicChanged  received: " + new String(data));
